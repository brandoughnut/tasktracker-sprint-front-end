    ...
    return (
        <div className='2xl:flex 2xl:justify-between 2xl:ms-[144px] 2xl:me-[47px]'>
            <div className='mt-[91px]'>
                ...
                <div className='flex justify-center 2xl:justify-between -mt-12'>
                    <div className='me-[240px]'>
            ...
            <div className='mt-[53px]'>
                <div className='bg-white border-[1px] border-black rounded-[5px] h-[789px] w-full 2xl:w-[1000px] overflow-auto'>
